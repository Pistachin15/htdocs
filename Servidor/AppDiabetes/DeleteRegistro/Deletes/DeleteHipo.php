...
if(isset($_POST['Enviar'])) {
    ...
    if ($filaVerificar['total'] != 0 && $filaVerificarComida['total'] != 0) {
        ...
        $borrarHipo = "DELETE FROM hipoglucemia WHERE fecha = '$fechaRecogida' AND tipo_comida = '$tipoComida'";

        if ($conn->query($borrarHipo) === TRUE) {
