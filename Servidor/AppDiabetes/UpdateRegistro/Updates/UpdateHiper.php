...
<head>
    ...
    <title>Actualización de Hiperglucemia</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="d-flex justify-content-center align-items-center vh-100">

    <div class="bg-white p-5 rounded shadow w-25">
        <h3 class="text-center mb-4">Actualización de Hiperglucemia</h3>
        ...
        <form action="UpdateHiper.php" method="post">
            ...
            <!-- Hora de la medición -->
            <div class="mb-3">
                <label for="horahiper">Selecciona la hora (formato 24 horas):</label>
                <input type="time" id="horahiper" name="horahiper" class="form-control" required>
            </div>
