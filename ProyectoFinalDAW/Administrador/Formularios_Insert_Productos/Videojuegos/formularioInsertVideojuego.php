...
<div class="container form-container">
  <div class="form-card">
    <h3 class="text-center mb-4">Insertar Nuevo Videojuego</h3>

    <?php if (isset($_GET['success']) && $_GET['success'] == 1): ?>
      <div class="alert alert-success text-center">¡Videojuego insertado correctamente!</div>
    <?php endif; ?>

    <form action="logicaVideojuego.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate onsubmit="return validarFormulario();">
      <div class="mb-3">
