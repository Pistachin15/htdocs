...
$sql = "SELECT * FROM productos WHERE tipo = 'videojuego'";
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="#">Juegos</a></li>
                ...
                <div class="card h-100 shadow-sm">
                    <a href="../detalle_producto.php?id=<?= $row['id_producto'] ?>" class="text-decoration-none text-dark">
                        <?php if (!empty($row['imagen'])): ?>
                            <img src="/ProyectoFinalDAW/Administrador/Formularios_Insert_Productos/Videojuegos/<?= htmlspecialchars($row['imagen']) ?>" class="card-img-top" alt="<?= htmlspecialchars($row['titulo']) ?>">
                        <?php else: ?>
