    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li><a href="../CarritoCompra/ver_cesta.php" class="btn btn-outline-primary me-2">🛒 Compra (<?= count($_SESSION['cesta'] ?? []) ?>)</a></li>
                <li><a href="ver_cesta_alquiler.php" class="btn btn-outline-primary">🎞 Alquiler (<?= count($_SESSION['cesta_alquiler'] ?? []) ?>)</a></li>
